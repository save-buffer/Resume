...
\resumeSubheading{Anthropic}{Seattle, WA}
{Member Of Technical Staff}{September 2024 - Present}
\resumeItemListStart
\resumeItem{Trainium Framework}
{Designed and implemented a framework for programming Amazon's Trainium chip. It was used for inference
of Claude 3.7 and Claude 4 models on Trainium across tens of thousands of chips.}
\resumeItem{Trainium Kernels}
{Implemented and optimized various kernels for training and inference (such as Attention) for Amazon's
Trainium 1 and Trainium 2 chips.}
\resumeItemListEnd
\vspace{2pt}
\resumeSubheading{Neon}{Remote (Seattle, WA)}
{Systems Software Engineer}{March 2023 - September 2024}
\resumeItemListStart
